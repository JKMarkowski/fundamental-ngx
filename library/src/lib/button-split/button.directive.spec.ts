...
describe('ButtonDirective', () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [ButtonSplitComponent, TestComponent]
        });
    }));
    ...
    beforeEach(() => {
        ...
        directive = debugElement.query(By.directive(ButtonSplitComponent));
        directiveInstance = directive.injector.get(ButtonSplitComponent);
